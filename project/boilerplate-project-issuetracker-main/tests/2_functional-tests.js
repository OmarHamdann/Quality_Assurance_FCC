        ...
        chai
          ...
          .end(function (err, res) {
            ...
            assert.deepEqual(res.body[0], {
              ...
              created_on: "2022-09-28T07:18:11.038Z",
              updated_on: "2022-09-28T07:18:11.038Z",
              created_by: "2020-12-21T15:41:38.279Z",
              assigned_to: "2020-12-21T15:41:38.279Z",
              open: true,
              status_text: "Landon",
            });
            done();
      ...
      test("View issues on a project with multiple filters: GET request to /api/issues/{project}", function (done) {
        chai
          ...
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.deepEqual(res.body[0], {
              _id: "6333f71e27bf3d001d10b4ec",
              issue_title: "Hey",
              issue_text: "testing",
              created_on: "2022-09-28T07:26:22.436Z",
              updated_on: "2022-09-28T07:26:22.436Z",
              created_by: "omar",
              assigned_to: "",
              open: true,
              status_text: "",
    ...
    suite("5 Put request Tests", function () {
      test("Update one field on an issue: PUT request to /api/issues/test-data-put", function (done) {
        chai
          ...
          .send({
            _id: "6333f8aeb5488f02767d53ed",
            issue_title: "different",
          })
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.equal(res.body.result, "successfully updated");
            assert.equal(res.body._id, "6333f8aeb5488f02767d53ed");
      ...
      test("Update multiple fields on an issue: PUT request to /api/issues/{project}", function (done) {
        chai
          ...
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.equal(res.body.result, "successfully updated");
            assert.equal(res.body._id, "6333f8bfb5488f02767d53f3");
